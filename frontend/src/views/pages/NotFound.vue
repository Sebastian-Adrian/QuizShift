...
<template>
    ...
    <div class="flex items-center justify-center min-h-screen overflow-hidden">
        <div class="flex flex-col items-center justify-center">
            <svg class="mb-8 w-32 shrink-0" fill="none" height="40" viewBox="0 0 54 40" width="54" xmlns="http://www.w3.org/2000/svg">
                <path
                    clip-rule="evenodd"
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, color-mix(in srgb, var(--primary-color), transparent 60%) 10%, var(--surface-ground) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                    ...
                    <router-link class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b" to="/">
                    ...
                    <router-link class="w-full flex items-center mb-8 py-8 border-surface-300 dark:border-surface-500 border-b" to="/">
                        <span class="flex justify-center items-center border-2 border-primary text-primary rounded-border" style="height: 3.5rem; width: 3.5rem">
                    ...
                    <Button as="index-link" label="Go to Dashboard" to="/" />
                </div>
            </div>
        </div>
    </div>
