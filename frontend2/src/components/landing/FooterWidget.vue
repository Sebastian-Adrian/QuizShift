    ...
    <div class="py-6 px-6 mx-0 mt-20 lg:mx-20">
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 md:col-span-2">
                <a class="flex flex-wrap items-center justify-center md:justify-start md:mb-0 mb-4 cursor-pointer" @click="smoothScroll('#home')">
                    <svg class="h-14 mr-2" fill="none" viewBox="0 0 54 40" xmlns="http://www.w3.org/2000/svg">
                        <path
                            clip-rule="evenodd"
            ...
            <div class="col-span-12 md:col-span-10">
                <div class="grid grid-cols-12 gap-8 text-center md:text-left">
                    ...
                    <div class="col-span-12 md:col-span-3">
                        ...
                        <a class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Events<img class="ml-2" src="/demo/images/landing/new-badge.svg" /></a>
