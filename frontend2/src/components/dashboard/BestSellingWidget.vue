...
<template>
    <div class="card">
        <div class="flex justify-between items-center mb-6">
            ...
            <div>
                <Button class="p-button-text p-button-plain p-button-rounded" icon="pi pi-ellipsis-v" @click="$refs.menu.toggle($event)"></Button>
                <Menu ref="menu" :model="items" class="!min-w-40" popup></Menu>
            </div>
        </div>
