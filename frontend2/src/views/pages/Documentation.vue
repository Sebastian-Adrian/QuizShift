...
<code>modules: [
    '@primevue/nuxt-module',
        ...
        <p class="text-lg mb-4">Install <a class="font-medium text-primary hover:underline" href="https://tailwindcss.com/docs/guides/nuxtjs">Tailwind CSS</a> with Nuxt using official documentation.</p>
