    ...
    <div class="flex flex-col md:flex-row gap-8">
        <div class="md:w-1/2">
            ...
            <div class="card">
                ...
                <AvatarGroup>
                    <Avatar :image="'https://primefaces.org/cdn/primevue/images/avatar/amyelsner.png'" shape="circle" size="large"></Avatar>
                    <Avatar :image="'https://primefaces.org/cdn/primevue/images/avatar/asiyajavayant.png'" shape="circle" size="large"></Avatar>
                    <Avatar :image="'https://primefaces.org/cdn/primevue/images/avatar/onyamalimba.png'" shape="circle" size="large"></Avatar>
                    <Avatar :image="'https://primefaces.org/cdn/primevue/images/avatar/ionibowcher.png'" shape="circle" size="large"></Avatar>
                    <Avatar :image="'https://primefaces.org/cdn/primevue/images/avatar/xuxuefeng.png'" shape="circle" size="large"></Avatar>
        ...
        <div class="md:w-1/2">
            ...
            <div class="card">
                ...
                <div class="flex items-center flex-col sm:flex-row">
                    <Chip :image="'https://primefaces.org/cdn/primevue/images/avatar/amyelsner.png'" class="mr-2 mb-2" label="Amy Elsner"></Chip>
                    <Chip :image="'https://primefaces.org/cdn/primevue/images/avatar/asiyajavayant.png'" class="mr-2 mb-2" label="Asiya Javayant"></Chip>
                    <Chip :image="'https://primefaces.org/cdn/primevue/images/avatar/onyamalimba.png'" class="mr-2 mb-2" label="Onyama Limba"></Chip>
                </div>
            </div>
